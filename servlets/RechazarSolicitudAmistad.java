...
/**
 * Servlet implementation class RechazarPeticion
 */
@WebServlet("/RechazarSolicitudAmistad")
public class RechazarSolicitudAmistad extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RechazarSolicitudAmistad() {
        super();
